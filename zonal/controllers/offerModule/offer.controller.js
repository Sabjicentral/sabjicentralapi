import { createOfferModel, deleteOfferByIdModel, editOfferByIdModel, getAllOfferModel, getOfferByIdModel, getOfferForEditByIdModel } from "../../models/offer.model.js";

export const createOffer = async (req, res) => {
    try {
       const {offerName,offerDescription,discountType,discountValue,startDate,endDate,productId} = req.body;
       console.log(req.body);
       

       if(!productId || !offerName || !offerDescription || !discountType || !discountValue || !startDate || !endDate) {
